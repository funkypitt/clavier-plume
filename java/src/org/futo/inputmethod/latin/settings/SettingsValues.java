...
public class SettingsValues {
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        // Plume : glissement sur espace = changement de langue (comme Gboard), appui long = trackpad (iOS)
        mSpacebarSwipeMode = prefs.getInt(Settings.PREF_SPACEBAR_SWIPE_MODE, Settings.SPACEBAR_MODE_LANGUAGE);
        // Plume : appui long sur espace = trackpad (iOS) ; le changement de langue reste
        // accessible par le glissement sur la barre et par le sélecteur de langues.
        mSpacebarHoldMode = prefs.getInt(Settings.PREF_SPACEBAR_HOLD_MODE, Settings.SPACEBAR_MODE_CURSOR);
        ...
        // Plume : aucune espace automatique dans les champs e-mail, mot de passe, URL et code
        // (plainte n°5 : « espace après suggestion dans les champs de login »)
        mAltSpacesMode = (inputAttributes.mIsEmailField || inputAttributes.mIsPasswordField
                || inputAttributes.mIsUriField || inputAttributes.mIsCodeField)
                ? Settings.SPACES_MODE_NONE
                : prefs.getInt(Settings.PREF_ALT_SPACES_MODE, Settings.DEFAULT_ALT_SPACES_MODE);

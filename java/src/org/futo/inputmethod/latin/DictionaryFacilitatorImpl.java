...
public class DictionaryFacilitatorImpl implements DictionaryFacilitator {
    private static final String[] PLUME_SHIPPED_DICTIONARY_TYPES = new String[] {
            Dictionary.TYPE_MAIN, Dictionary.TYPE_CONTACTS, Dictionary.TYPE_USER };
    ...
    /** Plume : présent dans un dictionnaire livré (principal, contacts, personnel Android),

...
val ThirdPartyList: List<ThirdPartyItem> = listOf(
    // --- Plume : base et sources de données ---
    TP(
        "FUTO Keyboard",
        "Clavier Plume est une version modifiée de FUTO Keyboard (moteur, interface, saisie vocale Whisper).",
        "https://github.com/futo-org/android-keyboard",
        "Copyright (c) FUTO Holdings Inc.",
        License.FUTO_SOURCE_FIRST_1_1
    ),
    TP(
        "Lexique 3.83",
        "Dictionnaire français : formes, catégories grammaticales et fréquences (New, Pallier, Brysbaert, Ferrand).",
        "http://www.lexique.org",
        "Copyright (c) Boris New & Christophe Pallier",
        License.CC_BY_SA_4_0
    ),
    TP(
        "Leipzig Corpora Collection",
        "Noms propres, bigrammes et h muet, via les dictionnaires expérimentaux de Helium314.",
        "https://github.com/Helium314/aosp-dictionaries",
        "Copyright (c) Universität Leipzig, Helium314",
        License.CC_BY_4_0
    ),
    TP(
        "XMLittré",
        "Vocabulaire passif : le Dictionnaire de la langue française d'Émile Littré, édition XML de François Gannaz.",
        "https://www.littre.org",
        "Copyright (c) François Gannaz",
        License.CC_BY_SA_3_0
    ),
    TP(
        "LanguageTool (ressources françaises)",
        "Vocabulaire d'aujourd'hui : marques, noms récents, néologismes, mots composés.",
        "https://languagetool.org",
        "Copyright (c) Daniel Naber, Marcin Miłkowski et contributeurs",
        License.LGPL_2_1
    ),
    TP(
        "Dicollecte / Grammalecte",
        "Dictionnaire orthographique français de Hunspell, utilisé pour valider les formes générées.",
        "https://grammalecte.net",
        "Copyright (c) Olivier R.",
        License.MPL_2_0
    ),
    TP(
        "LibreOffice (autocorrection française)",
        "Corrections de fautes courantes et abréviations sans majuscule.",
        "https://www.libreoffice.org",
        "Copyright (c) The Document Foundation",
        License.MPL_2_0
    ),
    TP(
        "Selawik",
        "Police de caractères du clavier.",
        "https://github.com/microsoft/Selawik",
        "Copyright (c) 2015 Microsoft Corporation",
        License.OFL1_1
    ),
    // --- FUTO Keyboard : dépendances d'origine ---
    TP(
        "AOSP LatinIME",

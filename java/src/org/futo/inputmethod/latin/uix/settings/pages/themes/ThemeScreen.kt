...
fun ThemeScreen(navController: NavHostController = rememberNavController()) {
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(innerPadding)) {
            ScreenTitle(stringResource(R.string.plume_home_appearance), showBack = true, navController)
            // Plume: built-in themes only; custom themes and the theme editor are not reachable
            ThemePicker({ }, { })
        }
    }
}
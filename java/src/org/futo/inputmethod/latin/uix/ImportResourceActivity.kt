...
object ResourceHelper {
    // Plume : anglais → modèle anglais ; toute autre langue → modèle multilingue embarqué
    val BuiltInVoiceInputFallbacks = mapOf(
        "en" to BUILTIN_ENGLISH_MODEL,
        "fr" to org.futo.voiceinput.shared.BUILTIN_MULTILINGUAL_MODEL,
        "de" to org.futo.voiceinput.shared.BUILTIN_MULTILINGUAL_MODEL,
        "it" to org.futo.voiceinput.shared.BUILTIN_MULTILINGUAL_MODEL,
        "es" to org.futo.voiceinput.shared.BUILTIN_MULTILINGUAL_MODEL,
    )

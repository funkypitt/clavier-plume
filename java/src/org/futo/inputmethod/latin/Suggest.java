        ...
        if (!isCorrectionEnabled
            ...
            if (suggestionResults.mFirstSuggestionExceedsConfidenceThreshold
                ...
                hasAutoCorrection = true;
                    ...
                    firstSuggestion, consideredWord,
                    // Plume : seuil plus bas pour les mots longs
                    org.futo.inputmethod.latin.plume.PlumeRules.autocorrectThreshold(consideredWord, autoCorrectionThreshold))) {

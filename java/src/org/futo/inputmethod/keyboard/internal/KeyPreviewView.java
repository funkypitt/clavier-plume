...
public class KeyPreviewView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    /** Plume : le fond est-il un ballon iOS ? */
    public org.futo.inputmethod.latin.plume.PlumeBalloonDrawable getPlumeBalloon() {
        return mBackground instanceof org.futo.inputmethod.latin.plume.PlumeBalloonDrawable
                ? (org.futo.inputmethod.latin.plume.PlumeBalloonDrawable) mBackground : null;
    }

...
public class KeyboardView extends View {
    ...
    /** Plume : opacité des étiquettes (0 = effacées) pendant le mode trackpad. */
    public static volatile float sPlumeLabelAlpha = 1.0f;
    ...
    protected void onDrawKeyTopVisuals(@Nonnull final Key key, @Nonnull final Canvas canvas,
        ...
        if (label != null && icon == null) {
            ...
            if (sPlumeLabelAlpha < 1.0f) blendAlpha(paint, (int)(255 * sPlumeLabelAlpha));
